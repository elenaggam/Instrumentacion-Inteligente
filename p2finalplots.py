...
if fija == 'k':
    ...
    for intR3 in intR3LISTA:
        ...
        # plt.show()
        plt.savefig(f'Graphs/k_fija/{intR3}_1.png', dpi=300)
        plt.clf()
        ...
        # plt.show()
        plt.savefig(f'Graphs/k_fija/{intR3}_2.png', dpi=300)
        plt.clf()
        ...
        # plt.show()
        plt.savefig(f'Graphs/k_fija/{intR3}_3.png', dpi=300)
        plt.clf()
        ...
        # plt.show()
        plt.savefig(f'Graphs/k_fija/{intR3}_4.png', dpi=300)
        plt.clf()
        ...
        # plt.show()
        plt.savefig(f'Graphs/k_fija/{intR3}_5.png', dpi=300)
        plt.clf()
        ...
        # plt.show()
        plt.savefig(f'Graphs/k_fija/{intR3}_6.png', dpi=300)
        plt.clf()
        ...
        plt.ylabel('Time (ms)')
        # plt.show()
        plt.savefig(f'Graphs/k_fija/{intR3}_7.png', dpi=300)
        plt.clf()
        ...
        # plt.show()
        plt.savefig(f'Graphs/k_fija/{intR3}_8.png', dpi=300)
        plt.clf()
        ...
        plt.ylabel('Voltage (V)')
        # plt.show()
        plt.savefig(f'Graphs/k_fija/{intR3}_9.png', dpi=300)
        plt.clf()
